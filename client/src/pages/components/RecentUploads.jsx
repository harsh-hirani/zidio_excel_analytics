        ...
        {/* <Table> */}
          ...
          <tbody className="divide-y divide-gray-100 ">
            ...
            {tableData.map((product) => (
              <tr key={product.id} className="cursor-pointer  rounded-2xl" onClick={()=>{navigate('/u/upload/'+product.id)}} >
                <td className="py-3">
                  <div className="flex items-center gap-3">
                ...
                <td className="py-3 text-gray-500 text-theme-sm ">
                    ...
                    onClick={(e)=>{
                        ...
                        apiClient.delete('/app/upload',{data:{id:product.id}}).then(res=>{
                            console.log(res);                            
